...
& "$qt_src_folder\configure.bat" -silent -debug-and-release -opensource -confirm-license `
    -platform win32-msvc -opengl dynamic -no-dbus -no-icu -nomake examples `
    -qt-freetype -qt-harfbuzz -qt-doubleconversion -qt-sqlite -qt-zlib -qt-libpng -qt-libjpeg `
    -skip qtwebview -skip qtwebengine -skip qtquick3d -skip qtquickcontrols -skip qtquickcontrols2 -skip qtquicktimeline`
