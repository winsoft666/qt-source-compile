...
$perl_folder = Join-Path $cur_script_folder "Strawberry\perl"
...
$env:Path += ";$perl_folder\bin"
$env:Path += ";$perl_folder\site\bin"
...
& "$qt_src_folder\configure.bat" -debug-and-release -opensource -confirm-license `
    ...
    -mp -optimize-size -D "JAS_DLL=0" -static -static-runtime -feature-relocatable -ltcg `
