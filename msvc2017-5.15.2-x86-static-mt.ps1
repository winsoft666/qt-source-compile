...
$prefix_folder = Join-Path $cur_script_folder "output2"
$build_temp_folder = Join-Path $cur_script_folder "temp2"
...
& "$qt_src_folder\configure.bat" -silent -debug-and-release -force-debug-info -strip -opensource -confirm-license `
